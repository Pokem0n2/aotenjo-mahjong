  ...
  const renderResult = () => {
    ...
    return (
      <div className={styles.resultScreen}>
        <h2 className={styles.resultTitle}>战斗结束</h2>
        <div className={styles.resultStats}>
          <p>得分: {battle.scoreThisBattle}</p>
          <p>获得星币: {battle.starCoinThisBattle}</p>
